						...
						<div class="panel-body">
							<table id="dHV"
								...
								<tbody>
									...
									<c:forEach var="tempPlan" items="${planDetails}">
										<c:set var="count" value="${count + 1}" scope="page" />
										<!-- init the update link-->
										<c:url var="updateLink" value="/Admin/Plan/updatePlan">
											<c:param name="planId" value="${tempPlan.planId}"></c:param>
										</c:url>
										<!--  end init link-->
										<!-- init the update link-->
										<c:url var="deleteLink" value="/Admin/Plan/deletePlan">
											<c:param name="planId" value="${tempPlan.planId}"></c:param>
										</c:url>
										<!--  end init link-->
										<tr>
											...
											<td><a href="${updateLink}" title="Update Plan Details"
												class="fa fa-edit"></a>&nbsp;&nbsp;&nbsp;&nbsp; 
												<a href="${deleteLink}" title="Delete Plan"
